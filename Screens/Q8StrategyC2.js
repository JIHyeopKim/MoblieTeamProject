...
const Q7StrategyC2 = (props) => {

    const C2 = useState("Strategy C Prompt 2\n")

    const Answer2 = useState("All right, you say he'll use 50 feet of fencing for the two sides along the length.\nNow, how much fencing can you add without going over 80 feet?")
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q8StrategyC3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["8-3-2"] != null){
