...
const Q7StrategyA = (props) => {

    const A1 = useState("Strategy A Prompt 1\n")
    
    const Answer1 = useState("What inequality will represent the situation?\nUse the letter “d” as your vairable")
    ...
    const submitBtn = () => {
        ...
        var keyword1 = '21d +';
        var keyword2 = '(250)(0.10) less than';
        var keyword3 = 'equal to 115';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q7StrategyA2")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["7-1-1"] != null){
