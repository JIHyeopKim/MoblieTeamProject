...
const Q8StrategyB = (props) => {
    ...
    const submitBtn = () => {
        ...
        var keyword1 = '2w';
        var keyword2 = '50 is less than';
        var keyword3 = 'equal to 80';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q8StrategyB2")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["8-2-1"] != null){
