...
const Q1StrategyA2 = (props) => {

    const A2 = useState("Strategy A Prompt 2")

    const Answer2 = useState("Ok, your\n" 
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
            updateDB()
            props.navigation.navigate("Q1StrategyABCConfirmation")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["1-1-2"] != null){
