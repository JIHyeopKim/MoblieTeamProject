...
const Q4StrategyA2 = (props) => {

    const A2 = useState("Strategy A\nPrompt 3\n")

    const Answer2 = useState("Ok, you guessed [x] points for Elena.\nThen how many would Karla and Faye win?")
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'Karla:';
        var keyword2 = 'equivalent to 2x';
        var keyword3 = 'Elena:';
        var keyword4 = 'equivalent to x+';
        var keyword5 = '30';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q4StrategyA3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["4-1-2"] != null){
