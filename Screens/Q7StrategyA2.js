...
const Q7StrategyA2 = (props) => {

    const A2 = useState("Strategy A Prompt 2\n")

    const Answer2 = useState("Nice job! That inequality looks good. Now can you solve for “d” and enter your answer as an inequality?")
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'd less than';
        var keyword2 = 'equal to 4';
        var keyword3 = '2/7';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q7StrategyA3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["7-1-2"] != null){
