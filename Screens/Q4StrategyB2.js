...
const Q4StrategyB2 = (props) => {

    const B2 = useState("Strategy B Prompt 2\n")

    const Answer2 = useState("Great! That equation looks good.\nNow, solve for e and enter your answer.")
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q4StrategyB3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["4-2-2"] != null){
