...
const Q6StrategyA = (props) => {

    const A1 = useState("Strategy A Prompt 1\n")
    
    const Answer1 = useState("What equation will represent the situation?\nUse the letter “x” as your variable")
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
          updateDB
            props.navigation.navigate("Q6StrategyA2")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["6-1-1"] != null){
