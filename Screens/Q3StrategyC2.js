...
const Q3StrategyC2 = (props) => {

    const C2 = useState("Strategy C Prompt 2\n")
    
    const Answer1 = useState("Great job! Can you find out how long all 6 of the shorter rectangles are combined?")
