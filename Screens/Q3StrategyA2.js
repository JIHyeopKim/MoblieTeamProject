...
const Q3StrategyA2 = (props) => {

    const A2 = useState("Strategy A\nPrompt 2\n")

    const Answer2 = useState("Yes! So she used 64.8 yards of fabric for six curtains.\nNow, how much fabric did she use for one curtain?")
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["3-1-2"] != null){
