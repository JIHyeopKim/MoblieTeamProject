    ...
    const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["8-1-1"] != null && row["8-1-2"] != null && row["8-1-3"] != null
                && row["8-1-4"] != null && row["8-2-1"] != null 
                && row["8-2-2"] != null && row["8-2-3"] != null && row["8-3-1"] != null
                && row["8-3-2"] != null && row["8-3-3"] != null ){
