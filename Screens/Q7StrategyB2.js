...
const Q7StrategyB2 = (props) => {
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'Answers will vary';
        var keyword2 = 'use "x"';
        var keyword2_1 = 'use x';
        var keyword3 = 'as variable';
        ...
        if(checkBoolean(string.includes(keyword2)) || checkBoolean(string.includes(keyword2_1))){
            a += 33;
          }
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q7StrategyB3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["7-2-2"] != null){
