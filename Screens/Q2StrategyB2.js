...
const Q2StrategyB2 = (props) => {

    const B2 = useState("Strategy B2\nPrompt 2\n")

    const AnswerB = useState("Your equation is equivalent to 16 1/8 + m = 22.\nCan you solve for m?");
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["2-2-2"] != null){
