...
const Q8StrategyB2 = (props) => {
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'w is less than';
        var keyword2 = 'equal to 15';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q8StrategyB3")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["8-2-2"] != null){
