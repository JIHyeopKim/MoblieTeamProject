...
const Q5StrategyA2 = (props) => {

    const A2 = useState("Strategy A Prompt 2\n")

    const Answer2 = useState("Nice job! That equation looks good.\nNow can you solve for “m”?")
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["5-1-2"] != null){
