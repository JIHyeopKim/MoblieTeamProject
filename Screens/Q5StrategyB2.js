...
const Q5StrategyB2 = (props) => {

    const B2 = useState("Strategy B Prompt 2\n")

    const Answer2 = useState("How many times can you add 8¼ inches to 34.5 inches to get 84 inches?")
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["5-2-2"] != null){
