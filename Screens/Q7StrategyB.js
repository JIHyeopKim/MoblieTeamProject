...
const Q7StrategyB = (props) => {
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
            updateDB()
            props.navigation.navigate("Q7StrategyB2")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["7-2-1"] != null){
