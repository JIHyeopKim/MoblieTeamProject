...
const Q4StrategyC = (props) => {

    const C1 = useState("Strategy C Prompt 1\n")
    
    const Answer1 = useState("Each tall rectangle is equal to the number of points that Elena won.\n"
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["4-3-1"] != null){
