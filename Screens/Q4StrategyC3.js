...
const Q4StrategyC3 = (props) => {

    const C3 = useState("Strategy C Prompt 3\n")

    const Answer3 = useState("That seems correct.\nSo then,\nhow many points did Karla and Faye score?")
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'Karla: 42';
        var keyword2 = 'Faye: 51';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q4StrategyC4")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["4-3-3"] != null){
