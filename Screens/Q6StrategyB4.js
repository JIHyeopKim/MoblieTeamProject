...
const Q6StrategyB4 = (props) => {

    const B4 = useState("Strategy B Prompt 4\n")

    const Answer4 = useState("Great! You got a perimeter of 104 inches.\nNow remember what you guessed.\nWhat is the width of the rectangle?")
    ...
    const submitBtn = () => {
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q6StrategyABConfirmation")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["6-2-4"] != null){
