...
const Q4StrategyB3 = (props) => {
    ...
    const submitBtn = () => {
        ...
        var keyword1 = 'Karla:';
        var keyword2 = '42 points';
        var keyword3 = 'Faye:';
        var keyword4 = '51 points';
        ...
        if(a == 100){
          updateDB()
            props.navigation.navigate("Q4StrategyB4")
            setAnswer("")
          a = 0;
      ...
      const answercheckDB = async ()=>{
        try{
            ...
            {students?.map((row) => {
                ...
                if(stuid == row.addName && row["4-2-3"] != null){
